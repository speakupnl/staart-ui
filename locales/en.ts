export default {
  errors: {
    ...
    "cannot-delete-sole-owner":
      "Add another owner to this group before deleting",
    "cannot-update-sole-owner":
      "Add another owner to this group before updating this role",
  ...
  securityEvents: {
    ...
    "group.created": "Created a new group",
  ...
  messages: {
    ...
    "group-created": "Your team has been created",
    "group-updated": "Your team has been updated",
    "group-deleted": "Your team has been deleted",
    "group-billing-updated": "Your team's billing info has been updated",
  ...
  webhooks: {
    "*": "All events",
    "update-group": "Update team settings",
    "delete-group": "Delete team",
    "update-group-billing": "Update billing details",
    "update-group-subscription": "Update subscription",
    "create-group-subscription": "Create a subscription",
    "delete-group-source": "Delete a payment method",
    "update-group-source": "Update a payment method",
    "create-group-source": "Create a payment method",
